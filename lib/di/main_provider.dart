...
import 'package:ls_server_app/use_case/listen_ssh_connect_use_case.dart';
...
import 'package:ls_server_app/use_case/ssh_log_out_use_case.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        Provider(create: (context) => (SshLogOutUseCase(
